...
重构引擎，2.0的生成文件缩小 <mark style="color:purple;">10 倍</mark> ，运行内存缩小 <mark style="color:orange;">5 倍</mark>，静态编译速度提升 <mark style="color:green;">8 倍</mark>，且支持了OPERATION增量编译，实现了无感编译！
...
{% hint style="info" %}
该特性为商业特性，获取License后方可激活，详情咨询微信：luxuncode
{% endhint %}

### 钩子扩展逻辑

OPERATION结合钩子能实现大部分接口，但仍有些接口无法实现，需要自行编写代码支持。原本我们只支持GraphQL

钩子和proxy钩子，本次我们支持了function钩子，且还解决了钩子的循环依赖问题。
...
* 购买授权：当前售价99元/设备，根据上线的增值服务，将持续调整价格
* 免费获取：当前仅内测用户可参与该活动

未来将持续推出更多增值服务，进一步提升开发体验！

<mark style="color:red;">如果您觉得某些政策不合理，请随时联系我们。我们将会慎重考虑您的建议！</mark>

## 结语

结束之际，最想感谢的是Fireboom内测群 **228名** 种子用户。是你们的使用、反馈、建议让我们走到今天！

**为此，群内所有用户都将**<mark style="color:blue;">**免费**</mark>**获得1年的**<mark style="color:blue;">**增量编译特权**</mark>**！**详情见 [文档](https://bar9vnf09af.feishu.cn/docx/Wz5TdGDseocuIWxPDRpcWY35nnb?from=from\_copylink)！
