...
{% hint style="info" %}
社区版 只允许个人开发者将其用于个人项目，而不能用于企业或商业用途。
{% endhint %}

### 付费购买授权

除了免费申领授权，还有高阶特性，需要付费才能使用。

当前，仅上线 1项增值服务：

* [#zeng-liang-bian-yi](v2.0-geng-xin-shuo-ming.md#zeng-liang-bian-yi "mention")

该特性当前售价 **99元/设备.年**，后续将根据上线的增值服务，持续调整价格。详情咨询微信：luxuncode&#x20;

未来将持续推出更多增值服务，进一步提升开发体验！例如：
...
**为此，群内所有用户都将**<mark style="color:red;">**免费**</mark>**获得1年的**<mark style="color:purple;">**增量编译特权**</mark>**！**前往[申请->](https://bar9vnf09af.feishu.cn/share/base/form/shrcnNDXxJKs7BUTIY4gEFCOvt6)
